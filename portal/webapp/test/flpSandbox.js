		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Informacion General del Alumno",
									"targetURL": "#comudep29InfoAlumportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comudep29InfoAlumportal-display": {
								"semanticObject": "comudep29InfoAlumportal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.udep29.InfoAlum.portal",
									"url": sap.ui.require.toUrl("com/udep29/InfoAlum/portal")
								}
							}
						}
					}
